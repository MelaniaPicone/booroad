  ...
  return (
    <div className='container'>
      <div className="row">
        ...
        <div className="col-12">
          <h2 className='text-center partecipants'>Partecipanti</h2>
        </div>
                ...
                <div className="accordion" >
                  <div className="accordion-item">
                    <h2 className="accordion-header">
                      <button className="traveler-card namestyle" type="button" data-bs-toggle="collapse" data-bs-target={`#${traveler.id}`} aria-expanded="false" aria-controls="collapseOne">
                    ...
                    <div id={traveler.id} className="accordion-collapse collapse" data-bs-parent="#accordionExample">
                      <div className="accordion-body">
                        <ul className='list-unstyled idlist'>
                          <li>
                            <p>
